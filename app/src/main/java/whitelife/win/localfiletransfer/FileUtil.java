...
public class FileUtil {
    ...
    public static String getFilePath(String fileName){
        String path=getSdCardPath()+File.separator+"文件传输"+File.separator+fileName;
        return path;
    }
    ...
    /**
     * @param fileName
     * @return download if success
     */
    public static boolean saveFile(byte[]data, final String fileName){
        boolean result = true;
